...
module.exports = data =>
  `// this file contains a test harness that was auto-generated by fastify-swaggergen
...
const fastifySwaggerGen = require("../${data.cliRunner}");

const swaggerSpec = "../${data.specFile}";
  ...
  fastify.inject(
    {
      ...
      payload: undefined, ${route.body ? `//insert headers here!!` : ""}
      headers: undefined ${route.headers ? `//insert headers here!!` : ""}
    },
    (err, res) => {
      t.error(err);
